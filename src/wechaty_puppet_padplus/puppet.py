"""
Python Wechaty Puppet Padplus - https://github.com/wechaty/python-wechaty-puppet-padplus
...
class PadPlusPuppet(Puppet):
    """
    grpc wechaty-puppet-padplus implementation
    """
